...
export declare const DEFAULT_OPERATIONS_CALENDAR: OperationsCalendar;
...
export declare const DEFAULT_PAYMENT_METHODS: PaymentMethodsConfig;
export declare const DEFAULT_PAYMENT_CONFIG: NormalizedPaymentConfig;
//# sourceMappingURL=settings.contracts.d.ts.map