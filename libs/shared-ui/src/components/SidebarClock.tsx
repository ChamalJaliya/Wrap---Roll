...
/**
 * Local wall clock for app sidebars (admin, POS, etc.) — updates on an interval
 * so the rest of the page does not re-render.
 */
export function SidebarClock({ compact, className }: SidebarClockProps) {
  ...
  if (compact) {
    return (
      ...
      >
        <span className="font-display text-[11px] font-black tabular-nums leading-none text-foreground">
          {time}
        </span>
