...
const list_filter_util_1 = require("./list-filter.util");
describe('list-filter.util', () => {
    it('builds prisma where for AND number/date/string rules', () => {
        const where = (0, list_filter_util_1.buildPrismaWhereFromFilters)({
            logic: 'AND',
            rules: [
    ...
    it('ignores unknown fields and invalid values', () => {
        const where = (0, list_filter_util_1.buildPrismaWhereFromFilters)({
            ...
            rules: [
                ...
                { field: 'price', op: 'gt', value: 'not-a-number' },
            ],
        }, {
            price: { kind: 'number' },
        });
    ...
    it('filters in-memory rows with OR logic', () => {
        ...
        const next = (0, list_filter_util_1.applyFiltersInMemory)(rows, {
            logic: 'OR',
            rules: [
...
//# sourceMappingURL=list-filter.util.spec.js.map