...
import { cashierPayloadToWrapOrder } from '@wrap-roll/order-kit';
import { normalizeCashierPhone, phoneDigits } from '../../../lib/phone';

const RAW_NEST_API_URL = process.env.NEST_API_URL ?? 'http://localhost:4000';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const wrapOrder = cashierPayloadToWrapOrder(
